...
qcno_dB_ArgMax1 = [15:0.5:23 30]; EArgMax = interp1(SFS.qcno_dB_ArgMax, SFS.EArgMax, qcno_dB_ArgMax1, 'cubic');
qcno_dB_ArgMax = qcno_dB_ArgMax1;
% qcno_dB_ArgMax = [15:0.5:23 30]; EArgMax = interp1(qcno_dB_ArgMax1, EArgMax, qcno_dB_ArgMax, 'cubic');
    
qcno_dB_Mean1 = [15:0.5:20 21.2 22]; EMean = interp1(SFS.qcno_dB_Mean, SFS.EMean, qcno_dB_Mean1, 'cubic');
% qcno_dB_Mean = qcno_dB_Mean1;
qcno_dB_Mean1(end) = qcno_dB_Mean1(end) + 0.01;
qcno_dB_Mean = [15:0.5:23.5]; EMean = interp1(qcno_dB_Mean1, EMean, qcno_dB_Mean, 'cubic');

qcno_dB_FLL1 = [15:1:30] - 0.3; EFLL = interp1(SFS.qcno_dB_FLL, SFS.EFLL, qcno_dB_FLL1, 'cubic');
qcno_dB_FLL = 15:0.5:30; EFLL = interp1(qcno_dB_FLL1, EFLL, qcno_dB_FLL, 'cubic');  
